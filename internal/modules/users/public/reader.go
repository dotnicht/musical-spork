...
type reader struct{ get queries.GetUserHandler }

func NewUserReader(get queries.GetUserHandler) UserReader { return reader{get: get} }
...
func (r reader) Exists(ctx context.Context, userID string) (bool, error) {
	...
	if errors.Is(err, domain.ErrUserNotFound) { return false, nil }
	return false, err
}
